...
volatile char* rx_circ_buff_head = &buffer[0];
//TODO: Create the tail pointer of the buffer
volatile char* rx_circ_buff_tail = &buffer[0] + (RX_CIRC_BUFF_LEN - 1);
